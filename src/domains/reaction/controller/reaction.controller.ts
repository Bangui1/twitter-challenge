...
const service: ReactionService = new ReactionServiceImpl(new ReactionRepositoryImpl(db), new PostServiceImpl(new PostRepositoryImpl(db), new UserServiceImpl(new UserRepositoryImpl(db))), new UserServiceImpl(new UserRepositoryImpl(db)))
