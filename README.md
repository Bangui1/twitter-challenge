...
- [x] Update `GET api/user/:user_id` to return `UserViewDTO` and if the user follows him.
...
- [x] Search for a testing framework and create some unit tests. Make a CI/CD pipeline using gitlab actions to run those tests.
